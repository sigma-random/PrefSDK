...
RSpecialInstructions[0x000000] = InstructionDefinition("SLL", InstructionType.Lsl, { OperandDefinition.rd, OperandDefinition.rs, OperandDefinition.shamt })
...
RSpecialInstructions[0x000003] = InstructionDefinition("SRA", InstructionType.Asr, { OperandDefinition.rd, OperandDefinition.rs, OperandDefinition.shamt })
...
RSpecialInstructions[0x000002] = InstructionDefinition("SRL", InstructionType.Lsr, { OperandDefinition.rd, OperandDefinition.rs, OperandDefinition.shamt })
