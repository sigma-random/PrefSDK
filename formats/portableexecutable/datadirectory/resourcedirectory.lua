...
function ResourceDirectory:__ctor(databuffer, formattree, section, directoryoffset)
...
function ResourceDirectory.getResourceName(formatdefinition, entry)
...
function ResourceDirectory.getNameInfo(formatdefinition, name)
...
function ResourceDirectory.getOffsetInfo(formatdefinition, offsettodata)
