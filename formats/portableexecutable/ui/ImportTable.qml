...
{
  id: exporttable
  Component { id: entrymodel; ListModel { } }
  ...
  SplitView
  {
    ...
    TableView
    {    
      TableViewColumn { role: "oft"; title: "OFTs"; width: exporttable.width / 3 }
      TableViewColumn { role: "ft"; title: "FTs (IAT)"; width: exporttable.width / 3 }
      TableViewColumn { role: "name"; title: "Name"; width: exporttable.width / 3 }
