...
local MC68HC05Features = { [0x00] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1,InstructionFeatures.Use2), [0x01] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1,InstructionFeatures.Use2),[0x02] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1,InstructionFeatures.Use2), [0x03] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1,InstructionFeatures.Use2), [0x04] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1,InstructionFeatures.Use2), [0x05] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1,InstructionFeatures.Use2), [0x06] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1,InstructionFeatures.Use2), [0x07] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1,InstructionFeatures.Use2), [0x08] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1,InstructionFeatures.Use2), [0x09] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1,InstructionFeatures.Use2), [0x0A] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1,InstructionFeatures.Use2), [0x0B] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1,InstructionFeatures.Use2), [0x0C] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1,InstructionFeatures.Use2), [0x0D] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1,InstructionFeatures.Use2), [0x0E] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1,InstructionFeatures.Use2), [0x0F] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1,InstructionFeatures.Use2),
                           ...
                           [0x20] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1), [0x21] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1), [0x22] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1), [0x23] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1), [0x24] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1), [0x25] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1), [0x26] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1), [0x27] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1), [0x28] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1), [0x29] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1), [0x2A] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1), [0x2B] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1), [0x2C] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1), [0x2D] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1), [0x2E] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1), [0x2F] = bit32.bor(InstructionFeatures.Jump,InstructionFeatures.Use1),
...
function MC68HC05Processor:analyze(instruction)
  ...
  local highnibble = bit32.rshift(instruction.type, 4)
  local lownibble = bit32.band(instruction.type, 0x0F)
  ...
  if highnibble == 0x0 then
    ...
    instruction.operand2.address = instruction:address() + 3 + bit32.compl2(instruction:next(DataType.UInt8), DataType:sizeOf(DataType.UInt8))
  ...
  elseif highnibble == 0x2 then
    instruction.operand1.type = OperandTypes.JumpNear
    instruction.operand1.datatype = DataType.UInt8
    instruction.operand1.address = instruction:address() + 2 + bit32.compl2(instruction:next(DataType.UInt8), DataType:sizeOf(DataType.UInt8))
...
function MC68HC05Processor:emulate(addressqueue, referencetable, instruction)
  if self.features[instruction.type] ~= InstructionFeatures.Stop then
    ...
    if bit32.band(features, InstructionFeatures.Use1) then
      self:touchArg(addressqueue, referencetable, instruction:address(), instruction.operand1, bit32.band(features, InstructionFeatures.Call) ~= 0)
    end
    
    if bit32.band(features, InstructionFeatures.Use2) then
      self:touchArg(addressqueue, referencetable, instruction:address(), instruction.operand2, bit32.band(features, InstructionFeatures.Call) ~= 0)
    end
